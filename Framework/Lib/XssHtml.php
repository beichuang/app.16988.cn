...
class XssHtml {
    ...
    private $m_xss;
    private $m_ok;
    private $m_AllowAttr = array('title', 'src', 'href', 'style', 'width', 'height', 'alt', 'target', 'align');
//    private $m_AllowAttr = array('title', 'src', 'href', 'id', 'class', 'style', 'width', 'height', 'alt', 'target', 'align');
     ...
     */
    public function __construct($html, $charset = 'utf-8', $AllowTag = array(), $m_AllowAttr = array()){
        $this->m_AllowTag = empty($AllowTag) ? $this->m_AllowTag : $AllowTag;
        $this->m_AllowAttr = empty($m_AllowAttr) ? $this->m_AllowAttr : $m_AllowAttr;
