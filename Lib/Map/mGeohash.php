...
class mGeohash {
	...
	private function calculateAdjacent($srcHash, $dir) {
		...
		return $base . $this->coding[(int)strpos($this->neighbors[$dir][$type], $lastChr)];
	}
	...
	public function getDistance($lat1, $lng1, $lat2, $lng2) {
        ...
        $lat2=floatval($lat2);
        $lng2=floatval($lng2);
	    $EARTH_RADIUS = 6378.137;//地球半径，平均半径为6371km
	...
	private function _rad($d) {
	    return $d * 3.14159265358979324 / 180.0;
	}
	
	private function _XPI() {
	 ...
	 */
	public function mySortASC($field, &$arr) {
