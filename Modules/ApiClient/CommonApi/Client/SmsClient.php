<?php
namespace ApiClient\CommonApi\Client;
...
class SmsClient extends ApiClient
{
     ...
     *            短信签名，默认【掌玩】
     * @throws \Exception
     * @return Ambigous <\ApiClient\CommonApi\Client\mixed, boolean, mixed, string>
     */
    public function sendSMS($templateType, $recNum, $vars = array(), $signName = '掌玩',$recNumCheck='N')
    {
        if (! $recNum) {
    ...
    private function buildRequestParams($templateType, $recNum, $sms_params, $signName = "掌玩")
    {
        $params = array();
